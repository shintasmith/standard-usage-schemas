...
.. |product name (TM)| unicode:: Rackspace U+0020 Cloud U+0020 Feeds U+2122
"""
...
html_title = 'Rackspace Cloud Feeds version 1.0 API Developer Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Feeds'
...
htmlhelp_basename = 'RackspaceCloudFeedsAIPIDeveloperDoc'
...
latex_documents = [
  ('index', 'Rackspace Cloud Feeds API Guide.tex',
   'Rackspace Cloud Feeds API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCloudFeedsApiDeveloperDoc', 'Rackspace Cloud Feeds API Developer Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCloudFeedsApiDeveloperDoc', 'Rackspace Cloud Feeds API Developer Guide',
   'Rackspace', 'RackspaceCloudFeedsApiDeveloperDoc',
   'Learn about using the REST API for the Rackspace Cloud Feeds service.',
   'Miscellaneous'),
]
